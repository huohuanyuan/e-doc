  ...
  <div class="core-library" ref="outWrapper">
    <div ref="topWrapper">
      <ul class="top">
        ...
        <li v-show="showBtn && privilege.coreDown" class="cell" @click="fileDown">{{$t('operation.fileDown')}}</li>
        <li v-show="showBtn && privilege.coreDown" class="cell" @click="signDown">{{$t('operation.sginDown')}}</li>
...
export default {
  ...
  methods: {
    ...
    getFileTree() {
      let _this = this;
      _this.spinShow = true;
      ApiGetLibraryFolder({ central: true }).then(function(res) {
