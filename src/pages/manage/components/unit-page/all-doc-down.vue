 ...
 * @Last Modified time: 2018-11-19 16:16:25
 */
<template>
    ...
    <div class="file-tree">
      ...
      <div class="content">
        ...
        <div ref="treeWrapper" class="tree-content">
          <el-tree ref="tree" :data="dirTreeData" node-key="id" :props="defaultProps" :render-content="renderContent" show-checkbox @node-click="dirSelected" @check="nodeCheck" empty-text=" ">
          </el-tree>
        </div>
      </div>
    </div>
